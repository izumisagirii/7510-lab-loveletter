...
title = Little_Love_Letter

# (str) Package name
package.name = littleloveletter

# (str) Package domain (needed for android/ios packaging)
package.domain = com.group

# (str) Source code where the main.py live
source.dir = .

# (list) Source files to include (leave empty to include all the files)
source.include_exts = py,jpg,kv,atlas,svg,png,ttf,json

# (list) List of inclusions using pattern matching
source.include_patterns = group_assets/*

# (list) Source files to exclude (leave empty to not exclude anything)
source.exclude_exts = spec

# (list) List of directory to exclude (leave empty to not exclude anything)
source.exclude_dirs = test, group_venv, bin
...
requirements = python3,kivy,kivymd,pillow,android,google-cloud-storage,firebase_admin,pyasn1,pyasn1_modules,rsa,cachetools,google-api-core,google-api-python-client,google-auth,google-auth-httplib2,google-cloud-core,google-cloud-firestore,google-crc32c,google-resumable-media,googleapis-common-protos,requests
...
presplash.filename = ./group_assets/images/l_hires.jpg

# (str) Icon of the application
icon.filename = ./group_assets/images/image.png
...
android.permissions = android.permission.WRITE_EXTERNAL_STORAGE, android.permission.READ_EXTERNAL_STORAGE, android.permission.INTERNET, android.permission.ACCESS_NETWORK_STATE
...
android.extra_manifest_application_arguments = ./group_assets/extra_manifest_application_arguments.xml
...
#android.add_packaging_options = requestLegacyExternalStorage="true"
